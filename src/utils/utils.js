...
export const cardTitleInput = addCardFormElement.querySelector("#modal-title-name");
...
export const modalCaption = modalImagePreview.querySelector(".modal__preview-caption");
export const previewExitButton = modalImagePreview.querySelector(".modal__close");
